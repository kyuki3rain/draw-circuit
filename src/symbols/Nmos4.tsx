...
const Nmos4: React.FC<Props> = ({ upperLeft, point, pitch }) => {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 109 216">
        ...
        <polygon stroke="black" strokeWidth={4} fill="none" points="36 108 90 99 90 108 90 117 36 108" />
        <line stroke="black" strokeWidth={4} fill="none" x1="108" y1="108" x2="90" y2="108" />
